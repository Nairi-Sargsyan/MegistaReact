...
const HeaderCover = () => {
    return (
        <section className='header__cover'>
            <div className="header__cover_title">
                <div className="container">
                    <div className="cover__title text-center">
                        <h1 className="title">Lorem Ipsum is simply dummy</h1>
                        <p>Lorem Ipsum is simply dummy text of the printing</p>
                    </div>
                    <div className="cover__button text-center">
                        <button className="btn btn__play">Play now</button>
                    </div>
                </div>
            </div>
            <div className="header__cover_social w-100">
                <div className="container">
                    <div className="cover__social text-md-end text-center">
                        <a href="/" className="btn border-0 me-2">
                            <svg className="mg-discord-btn" width="34" height="34" viewBox="0 0 34 34" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <a href="/" className="btn border-0 me-2">
                            <svg className="mg-facebook-btn" width="26" height="26" viewBox="0 0 26 26" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <a href="/" className="btn border-0">
                            <svg className="mg-youtube-btn" width="30" height="22" viewBox="0 0 30 22" fill="none" xmlns="http://www.w3.org/2000/svg">
